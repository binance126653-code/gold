...
# Credentials (GitHub Push Protection ကြောင့် raw token များကို ဖယ်ရှားထားပါသည်။ Environment variables များတွင် ထည့်သွင်းအသုံးပြုပါ)
BOT_TOKEN = os.getenv('BOT_TOKEN', 'YOUR_BOT_TOKEN_HERE')
GITHUB_TOKEN = os.getenv('GITHUB_TOKEN', 'YOUR_GITHUB_TOKEN_HERE')
ADMIN_ID = "6798489287"
REPO_OWNER = "binance126653-code"
REPO_NAME = "gold"
...
async def handle_input(message):
    ...
    if message.chat.id in user_data:
        ...
        if await check_session_url(session_url=url):
            ...
            await bot.reply_to(message, "Session URL မမှန်ကန်ပါ။")
    else:
        await bot.reply_to(message, "/input ကိုအသုံးမပြုမီ /key ကိုအရင်ပြုလုပ်ပေးပါ။")
